...
class TodoitemsControllerTest < ActionController::TestCase
  ...
  test "should create todoitem" do
    assert_difference('Todoitem.count') do
      post :create, todoitem: { completed: @todoitem.completed, description: @todoitem.description, due_date: @todoitem.due_date, title: @todoitem.title, todo_list_id: @todoitem.todo_list_id }
    end
  ...
  test "should update todoitem" do
    patch :update, id: @todoitem, todoitem: { completed: @todoitem.completed, description: @todoitem.description, due_date: @todoitem.due_date, title: @todoitem.title, todo_list_id: @todoitem.todo_list_id }
    assert_redirected_to todoitem_path(assigns(:todoitem))
  end
